...
class OrientationTracker {
  ...
  public:
    ...
    const Quaternion& getQuaternionMadgwick() const { return quaternionMadg; };
    const Quaternion& getQuaternionMah() const { return quaternionMah; };
     const Quaternion& getQuaternionEKF() const { return quaternionEKF; };
  ...
  protected:
    ...
    /**
     * estimate of quaternion orientation
     * from madgwick filter of acc and gyr
     */
    Quaternion quaternionMadg;

    /**
     * estimate of quaternion orientation
     * from mahony filter of acc and gyr
     */
    Quaternion quaternionMah;
    double eInt[3]; // persistent Integration error

    /**
     * estimate of quaternion orientation
     * from madgwick filter of acc and gyr
     */
    Quaternion quaternionEKF;
